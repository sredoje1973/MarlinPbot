 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        40 // Seconds 0 printrbot: increasing from 20 to 40 due to false positives
  #define THERMAL_PROTECTION_BED_HYSTERESIS     4 // Degrees Celsius -printrbot : increasing from 2 to 4 due to false positives
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN  // setting to FAN1_PIN 
